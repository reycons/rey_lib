...
class Control:
    ...
    def enrich_data_profile(self, data_profile_id: int,
        ...
        Args:
            ...
            profile_method_version: Version of that method.
            row_count: Rows observed.
            size_bytes: Size of the representation read.
            distribution: The per-profile distribution summary.
            required: Raise on failure rather than marking control unavailable.
        """
        self._call("enrich_data_profile", {
